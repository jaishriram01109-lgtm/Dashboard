...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // CSS-variable-driven — automatically switches with light/dark theme
        bg: {
      ...
      boxShadow: {
        card:       "0 1px 3px rgba(0,0,0,0.4), 0 0 0 1px rgba(139,0,0,0.1)",
        "card-hover":"0 4px 20px rgba(0,0,0,0.5), 0 0 0 1px rgba(139,0,0,0.3)",
